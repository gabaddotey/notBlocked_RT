...
export const questionList: Map<number, Question> = new Map<number, Question>([
  ...
  [5, newQuestion(5, 'Are you interested in creative activities? Which ones appeal to you? (Select all that apply)', ["Drawing / Painting", "Photography / Videography", "Creative Writing", "Music (Playing / Composing)", "Crafting / DIY", "Digital Design", "Performing Arts (Acting, Dance)", "None / Not Interested"], 6, "multi")],
  [6, newQuestion(6, 'How do you prefer to socialize during activities?', ["Large Groups", "Small Groups", "One-on-One / Partner", "With Family (including kids)", "Solo"], 7, "single")],
